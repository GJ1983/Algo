...
int main()
{
	...
	py->bark();  // Even py is NULL, still the bark function will get call, as it is not accepting any members of yellowdog, so compiler will treat it as a static function
